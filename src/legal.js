  ...
  legal: {
    en: {
      ...
      sections: [
        ...
        { h: 'Hosting',
          p: 'This application is hosted on OVH SAS (2 rue Kellermann, 59100 Roubaix, France). OVH\'s terms of service and privacy policy apply to the hosting infrastructure.' },
    ...
    fr: {
      ...
      sections: [
        ...
        { h: 'Hébergement',
          p: 'Cette application est hébergée par OVH SAS (2 rue Kellermann, 59100 Roubaix, France). Les conditions d\'utilisation et la politique de confidentialité d\'OVH s\'appliquent à l\'infrastructure d\'hébergement.' },
    ...
    de: {
      ...
      sections: [
        ...
        { h: 'Hosting',
          p: 'Diese Anwendung wird bei OVH SAS (2 rue Kellermann, 59100 Roubaix, Frankreich) gehostet. Die Nutzungsbedingungen und Datenschutzrichtlinie von OVH gelten für die Hosting-Infrastruktur.' },
    ...
    es: {
      ...
      sections: [
        ...
        { h: 'Alojamiento',
          p: 'Esta aplicación está alojada en OVH SAS (2 rue Kellermann, 59100 Roubaix, Francia). Los términos de servicio y la política de privacidad de OVH se aplican a la infraestructura de alojamiento.' },
    ...
    it: {
      ...
      sections: [
        ...
        { h: 'Hosting',
          p: "Questa applicazione è ospitata da OVH SAS (2 rue Kellermann, 59100 Roubaix, Francia). I termini di servizio e l'informativa sulla privacy di OVH si applicano all'infrastruttura di hosting." },
